...
const DeleteModal = ({ isModalOpen, handleCancel, handleOk }: any) => {
    ...
    return (
        ...
        <Modal centered style={{ textAlign: "center" }} onOk={handleDelete} wrapClassName="blocking-main" open={isModalOpen} onCancel={handleCancel} okText="Delete">
            ...
            <span></span>
            <p className='fs-24 fw-700 sure' style={{ color: "#0E0E0E", textAlign: "center", margin: "20px" }}>Are You Sure?</p>
