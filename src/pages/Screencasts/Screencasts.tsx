...
import DownloadModal from "../../components/ScreenCasts/DownloadModal";
import DeleteModal from "../../components/ScreenCasts/DeleteModal";
            ...
            <div className="d-flex">
              ...
              {selected.length > 1 && (
                <>
                  ...
                  />
                  <Button shape="circle" className="icon-button download-all" onClick={() => setOpenDownloadModal(true)}>
                    <img width={16} height={14} src={DownloadIcon} alt="icon" />
                  </Button>
                </>
              )}
            </div>
