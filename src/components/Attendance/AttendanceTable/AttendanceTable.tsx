...
const ATTENDANCETABLECOLUMNS: ColumnsType<IAttendanceTableData> = [
  ...
  },
  {
    ...
    render: (status, attendance) => (
      <button
        className="cursor-pointer text-white fs-12 fw-600 line-height-22 fw-600 "
        style={{ padding: "0.21rem 0.631rem", border: 0, borderRadius: "45px", backgroundColor: attendance.defaultColor }}
      >
        {status }
      </button>
    ),
...
export const AttendanceTableTooltip = ({
  ...
  return (
    <div className="" style={{ padding: "0.688rem 1.75rem" }}>
      <h3 className="fs-20 fw-600 line-height-30" style={{ margin: "0.688rem 0 0 0 " }}>
        {shiftName}
      </h3>
      <Divider
        style={{
      ...
      <Row gutter={[16, 16]} className="m-0">
        <Col xs={12} className="m-0">
          <p className="fs-12 fw-400 line-height-18" style={{ margin: "1rem 0 0 0" }}>
            Shift Start time
          </p>
          <p className="fs-14 fw-400 line-height-22" style={{ marginTop: "0.125rem" }}>
            {actualStartTime}
          </p>
        </Col>
        <Col xs={12} className="m-0">
        ...
        <Col xs={12} className="m-0">
          <p className="fs-12 fw-400 line-height-18 border-color" style={{ margin: "1rem 0 0 0" }}>
            Relaxation time:
          </p>
          <p className="fs-14 fw-400 line-height-22 grey-color" style={{ marginTop: "0.125rem" }}>
            15min
