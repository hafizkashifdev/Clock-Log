...
import Keyboard from "../../../assets/images/timeline/keyboard.png";
import mouse from "../../../assets/images/timeline/mouse.png";
                            ...
                            <Card className="bgWhite-color innerCard" bodyStyle={{ padding: "15px" }}>
                                ...
                                <Row gutter={8} style={{ marginTop: "18px" }}>
                                    <Col xs={24} md={24} lg={24} xl={12}>
                                        <div className="d-flex cardFooter button-stat-bg" >
                                            <div className="d-flex">
                                                <img width="100%" style={{ marginRight: "10px" }} src={Keyboard} alt="Keyboard" />
                                    ...
                                    <Col xs={24} md={24} lg={24} xl={12}>
                                        <div className="d-flex cardFooter button-stat-bg" >
                                            <div className="d-flex" >
                                                <img width="100%" style={{ marginRight: "10px" }} src={mouse} alt="Mouse" />
