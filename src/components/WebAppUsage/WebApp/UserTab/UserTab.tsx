...
const UserTab = (props: any) => {
  ...
  const UserTableConstants = ({ setIsShowUserActivity }: UserTableProps) => {
    ...
    <div className="user-webapp-wrapper">
      <div className="rightSearch d-flex justify-end" style={{ marginBottom: "20px" }}>
        ...
        <div className="d-flex align-center">
          ...
          >
            <Button className="d-flex align-center column_btn fw-500">
        ...
        <Col span={24}>
          <div className="user-table  table-dark-theme">
            <Table
              ...
              columns={UserTableConstants({ setIsShowUserActivity })}
              dataSource={webUserData}
