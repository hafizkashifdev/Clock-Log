        ...
        <>
          ...
          >
            <Button
              ...
              className="fs-16 fw-500 line-height-24 d-flex align-center button-light-bg-color cursor-pointer add-exception-btn "
          ...
          <Modal
            title="Add Exception"
            okText="Save"
            wrapClassName="add-exception-modal-classes"
            closable={false}
            centered
          ...
          <Modal
            ...
            centered
            wrapClassName="achivement-edit-modal"
          ...
          <Modal
            ...
            centered
            width={445}
            wrapClassName="achivement-delete-modal"
          ...
          >
            ...
            <p
              className="fs-24 fw-600 sure text-center line-height-40"
              style={{ color: "#0E0E0E", margin: "1.25rem 0 0.625rem 0" }}
            >
              Are You Sure?
            </p>
            <p
