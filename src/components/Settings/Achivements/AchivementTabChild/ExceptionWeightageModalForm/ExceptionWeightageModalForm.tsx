    ...
    >
      <h2 className='fs-16 fw-500 title-color line-height-400 heading-color d-flex align-items-center' style={{marginTop:"0px"}}>
        ...
        <Tooltip
          ...
          <img src={infoImage} alt="info" className="cursor-pointer" style={{ margin: "0.5rem 0.625rem" }}  />
        </Tooltip>
      </h2>
        ...
        rules={[          { required: true, message: "Input required" },          { validator: validateWeightage },        ]}
        hasFeedback>
