...
const AddLocationForm = (props: any) => {
  ...
  const onFinish = (values: any) => {
    ...
    //     mailingAddress: values.mailaddress,
  ...
  return (
    ...
    >
      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} sm={12}>
          <Form.Item
            ...
            name="secondaryPhone"
            rules={[{ required: true, message: "Secondary Phone is required" }]}
        ...
        <Col xs={24} sm={12}>
          <Form.Item className="formlable" label="Fax" name="fax" rules={[{ required: true, message: "Fax is required" }]} >
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} sm={12}>
          <Form.Item className="formlable" label="Zip" name="mailZip" rules={[{ required: true, message: "Zip is required" }]} >
      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} sm={12}>
          <Form.Item className="formlable" label="City" name="mailCity" rules={[{ required: true, message: "City is required" }]} >
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} sm={12}>
          <Form.Item className="formlable" label="Zip" name="billingZip" rules={[{ required: true, message: "Zip is required" }]} >
      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} sm={12}>
          <Form.Item className="formlable" label="City" name="billingCity" rules={[{ required: true, message: "City is required" }]} >
