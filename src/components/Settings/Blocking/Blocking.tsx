    ...
    },
    {
      ...
      render: (status: any, record: any, index: any) => (
        <div>
          ...
          >
            <Switch style={{ color: "#E76F51" }} defaultChecked={index} />
          </Tooltip>
        </div>
      ),
    },
  ...
  return (
    <div className="blocking-main">
      <>
        <Row>
          <Col lg={12} md={12} sm={24} xs={24}>
            <Button
              ...
              className="fs-16 fw-500 line-height-24 d-flex align-center button-light-bg-color cursor-pointer"
              style={{
                padding: "0.5rem 1rem",
                gap: "0.583rem",
                margin: "15px",
          ...
          <Col lg={12} md={12} sm={24} xs={24}>
            ...
            <div className="searchBar">
              <Input
                ...
                prefix={
                  <SearchOutlined
                    style={{ fontSize: "17px", color: "#98A2B3" }}
        ...
        <Modal
          title={
            <span className="fs-16 fw-500" style={{ color: "#0E0E0E" }}>
              {buttonText} Domain
            </span>
          }
          okText={buttonText}
          wrapClassName="add-exception-modal-classes-blocking"
          closable={false}
          width={443}
          centered
