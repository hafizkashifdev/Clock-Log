...
function ScheduleReports() {
  ...
  const columns: ColumnsType<DataType> = [
    ...
    },
    {
      title: "Active",
      dataIndex: "active",
      render: (active: boolean, record: any) => <Switch checked={active} onChange={(checked: any) => onSwitchChange(checked, record)} />,
    },
    {
      title: "Actions",
      dataIndex: "actions",
  ...
  return (
    <div className="schedule_reports">
      <Row>
      ...
      <Table scroll={{ x: `max-content` }} className="wrapper-table" rowSelection={rowSelection} columns={columns} dataSource={rowData} />
      {deleteModal && <DeleteModal deleteModal={deleteModal} setDeleteModal={setDeleteModal} />}
      {resetUser && <ResetUser rowData={rowData} resetUser={resetUser} setResetUser={setResetUser} rowIndex={rowIndex} />}
    </div>
  );
}
