    ...
    >
      <Form form={form} onFinish={onFinish} onFinishFailed={onFinishFailed}>
            ...
            header={
              <div
                ...
                style={{
                  ...
                  border: `1px solid ${
                    selectedValues.length > 0 ? "#E6E6E6" : borderUsers
                  }`,
                  borderRadius: "0px",
            ...
            header={
              <div
                ...
                style={{
                  padding: "0.625rem 1rem",
                  border: `1px solid ${
                    selectedServicesValues.length > 0 ? "#E6E6E6" : borderUsers
                  }`,
                  borderRadius: "0px",
                  backgroundColor: "white",
                }}
        ...
        >          <Select value={selectedOption}
          ...
          className="ProductivityStatusTagged" placeholder={<span className="fs-14 fw-400 line-height-20">Select Productivity Status</span>}          >            {ProductivityStatus.map((option) => (
