...
const SettingsWebApps = (props: any) => {
  ...
  const items: TabsProps['items'] = [
    {
      key: '1',
      label: <div className="SettingTab d-flex align-items-center"><img src={categories} alt="categories"/>Categories</div>,
      children: <Categories/>,
    },
    {
      key: '2',
      label:  <div className="SettingTab d-flex align-items-center"><img src={ExceptionsImg} alt="ExceptionsImg"/>Exceptions</div>,
      children:<Exceptions/>,
    },
  ];
    return (
