          ...
          <Row>
            ...
            <Col xs={24} sm={12}>
              <div className='d-flex'><p className="attendance-summary-text title-color fs-16 fw-600 " style={{ marginTop: "0px" }}>Distraction Alerts</p>
                <Tooltip overlayStyle={{ width: '311px',height: "37px",borderRadius:"4px" }} placement="right" title={<span className='fw-4-- fs-14 ' style={{color:"#FCFCFD"}}>A list of all the triggered distraction alerts</span>}>
