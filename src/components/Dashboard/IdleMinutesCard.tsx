  ...
  return (
    <Layout className="dashboard bg-unset">
      ...
      <div  style={{display:"flex"}}>
       ...
       <Tooltip overlayStyle={{ width: '306px',height: "58px" ,borderRadius:"4px"}} placement='right' title={<span className="fw-400 fs-14" style={{color:"#FCFCFD"}}>Total Idle time (Time in which there
was no activity recorded on the system)
        ...
        <img src={infocircle} alt="info" className="white-img-theme-class cursor-pointer" style={{ marginLeft: '5px',marginBottom:"15px" }} />
          ...
          <Row>
            ...
            <span className="showmore fw-500 fs-16  lowest " onClick={()=>{setSelectedProductivityLevel(1);setHighestLinkColor("#E76F51");setLowestLinkColor("");}} style={{color: highestLinkColor}}>Highest</span>
          ...
          return (
            <Row gutter={16} key={uuidv4()}>
              ...
              <Col lg={4} md={6} xs={24} sm={24} className="score-value text-center" >
                <span className='fs-14 grey-color'>{score.idle}%</span>
              </Col>
