      ...
      {selectedOptions.includes("Productivity Hours") && <Card className="overallscore productivity-card  border-radius-8 card-bg-color" bordered={false} style={{ boxShadow: "0px 1px 6px rgba(0, 0, 0, 0.15)" }}>
        <div className="attendance-summary d-flex justify-between">
          <div style={{ display: "flex" }}>
            ...
            <Tooltip overlayStyle={{ width: '321px', height: "58px", borderRadius: "4px" }} placement="right" title={<span className='fw-400 fs-14' style={{ color: "#FCFCFD" }}>Users with highest productivity score from
          ...
          <div className="filter-score">
            <Row>
              <Col sm={12} style={{ borderRight: "1px solid #a0acbb" }}>
                <span className="showmore fw-500 fs-16 lowest " onClick={() => { setCounter(1); setHighestLinkColor("#E76F51"); setLowestLinkColor(""); }} style={{ color: highestLinkColor }}>Highest</span>

              </Col>
              <Col sm={12} className="lowestfiltertext">
                <span className="lowest fs-16" onClick={() => { setCounter(2); setHighestLinkColor(""); setLowestLinkColor("#E76F51"); }} style={{ color: lowestLinkColor, margin: "10px" }}>Lowest</span>
              </Col>
            </Row>
          </div>
        </div>
