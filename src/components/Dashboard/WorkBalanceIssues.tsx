          ...
          <Row>
            <Col xs={24} sm={12}>
              <div style={{ display: "flex", alignItems: "center" }}>
                ...
                <Tooltip overlayStyle={{ width: '304px', height: "58px", borderRadius: "4px" }} placement="right" title={<span className='fw-400 fs-14' style={{ color: "#FCFCFD" }}>Top work load balance related issues in
            ...
            >
              ...
              >
                <Row className="utilized-container">
                  <Col xs={12}>
                    <h4 className="m-0 underutilized dark-pink-color fs-18">Underutilized</h4>
                  </Col>
                  <Col
                    xs={12}
                    style={{ textAlign: "end" }}
          ...
          <Col lg={12} md={12} sm={24} xs={24} className="work-issues-order1 overutilized-work-issues-order">
            ...
            >
              ...
              >
                <Row className="utilized-container">
                  <Col xs={12}>
                    <h4 className="m-0 underutilized dark-pink-color fs-18">Overutilized</h4>
                  </Col>
                  <Col
                    xs={12}
                    style={{ textAlign: "end" }}
