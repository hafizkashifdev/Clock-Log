...
const ScreenShotCard = (props: ISSCard) => {
  const { id, checkboxHandler, handleOpenPreview, selected, setOpenDeleteModal, setOpenDownloadModal, showCheckBoxes } = props;
      ...
      >
        ...
        {!showCheckBoxes && (
          <div className="card-btn" style={{ display: "flex", justifyContent: "flex-end", alignItems: "center", gap: "20px", marginTop: "10px" }}>
            <Button shape="circle" className="icon-button icons-div-color download" size="small" onClick={() => setOpenDownloadModal(true)}>
