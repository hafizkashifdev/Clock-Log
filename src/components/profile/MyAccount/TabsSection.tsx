      ...
      >
        <div>
          ...
          <div className="tab-wrapper">
            <p
              className={`fs-14 title-color m-0 d-flex align-center  select-label-color ${selectedTab === 1 ? "selected-tab" : "tabs-styles"} `}
            ...
            <p
              className={`fs-14 title-color m-0 select-label-color d-flex align-center  ${props.isModalOpen ? "selected-tab" : "tabs-styles"} `}
              onClick={() => {
                props.showModal();
                onSetTab(2);
              }}
            ...
            <p
              className={`fs-14 title-color m-0 select-label-color d-flex align-center  ${props.isModalTwoOpen ? "selected-tab" : "tabs-styles"} `}
              onClick={() => {
