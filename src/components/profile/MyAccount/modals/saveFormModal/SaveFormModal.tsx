        ...
        <Row style={{ textAlign: "center" }}>
          <Col xs={24}>
            <div className="action-modal">
              ...
              >
                <img src={SaveForm} alt="save" style={{position:'absolute',top:"13px",right:'13px'}}/>
              </div>
              <h2 className="fs-24 fw-600 heading-color">Are you sure?</h2>
              <p
                className="fs-12 fw-400 account-modal-responsivness"
              >
                Your request for profile update has been sent to Admin. Once
                approved by admin, your profile will be updated accordingly.
              </p>
              <div></div>
              <Button
