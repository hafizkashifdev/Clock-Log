...
const CreateTeamModal = () => {
    ...
    return (
        <div  >
            <Button className="btn-simple d-flex fw-500 fs-16" onClick={() => setCreateTeamModalOpen(true)}>
            ...
            <Modal centered title={<span className='fw-400 fs-16 title-color'> Add Team</span>} className='custom-stepper-wrapper' open={isCreateTeamModalOpen} onOk={OpenTeamModal} onCancel={CloseTeamModal}
                footer={[
                    <Row  >
