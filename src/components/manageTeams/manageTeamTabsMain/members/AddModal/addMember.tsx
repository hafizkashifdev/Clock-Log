...
const AddMember = () => {
  ...
  return (
    <div>
      <Button
        icon={
          <img src={ArchiveAddMemberIcon} alt="createTeam" width="18px" height="18px"
          />
        }
        className="btn-simple btn-create-team d-flex justify-between align-center fw-500 fs-16"
        onClick={showModal}
      >
        <span
