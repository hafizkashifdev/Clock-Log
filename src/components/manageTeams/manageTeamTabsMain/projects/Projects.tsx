        ...
        <Row>
          <Col span={24}>
            <>
              ...
              {isShowMessage && projects.length === 0 && <span style={{ color: "#ff4d4f" }}> Input Required  </span>}
      ...
      <Row gutter={[0, 20]} className="d-flex justify-between">
        <Col xs={24} md={8} xl={8}>
          <Space className="d-flex align-center" style={{ height: '100%' }}>
            <span className=" fw-600 fs-16 ">Business Analyst </span>
            <span>
        ...
        <Col xs={24} md={16} xl={16}>
          <div className="activite-search-main d-flex justify-end">
            <Input placeholder="Search Project" className="activitySearch" onChange={(e) => console.log(e.target.value)}
              prefix={<SearchOutlined className="site-form-item-icon" />}
              style={{ marginRight: '15px', height: '40px' }} />
            {keyValue === 'Active' && <div className="d-flex align-center">
              <Button icon={<img src={ArchiveAddProjectIcon} alt="craeteTeam" width="18px" height="18px" />}
                className="btn-simple d-flex justify-between align-center fw-500 fs-16" onClick={showModal}>
