        ...
        <Form layout="vertical" name="email" onFinish={onFinish}>
          <Row gutter={[20, 20]}>
            <Col xl={24} xs={24} md={24} lg={24} xxl={24} >
              ...
              {isShowMessage && !teamMember && <span style={{ color: "#ff4d4f", position: "absolute" }}> Input Required </span>}
            </Col>
            <Col xl={12} xs={24} sm={12} md={12} >
              <>
                ...
                <div style={{ position: "absolute" }}>
                  {isShowMessage && mateModal.length === 0 && <span style={{ color: "#ff4d4f" }}> Input Required </span>}
                </div>
              </>
            ...
            <Col xl={12} xs={24} sm={12} >
              ...
              <>
                ...
                <div style={{ position: "absolute" }}>
                  {isShowMessage && managers.length === 0 && <span style={{ color: "#ff4d4f" }}> Input Required </span>}
                </div>
              </>
            </Col>
            <Col xl={12} xs={24} sm={12}>
