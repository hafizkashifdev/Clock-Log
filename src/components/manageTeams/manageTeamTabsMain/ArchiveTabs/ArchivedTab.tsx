...
import ActiveGroup from '../../../../assets/icons/active_group.svg'
            ...
            <Row >
              ...
              <Col xs={24} sm={12} className='d-flex justify-end'>
                <div className="d-flex justify-end activite-search-main">
                  <Input placeholder="Search Team" className="activitySearch" onChange={(e) => console.log(e.target.value)}
          ...
          <div className="active-team-main " style={{ height: "100%" }}>
            {selectedRowKeys.length === 1 ?
              <div className="wrap-manage-team-member-table-tabs">
                <Tabs defaultActiveKey="members" items={tabsData} />
              </div>
              :
