export const TooltipsData = {
    overall: <div>
        <span className="fs-12 fw-700 line-height-18 black-color">Overall Score</span>
        <span className="fs-12 fw-400 line-height-18 black-color" style={{ display: "block",textAlign:'justify' }}>
    ...
    productivityScore: <div>
        <span className="fs-12 fw-700 line-height-18 black-color">Productivity Score</span>
        <span className="fs-12 fw-400 line-height-18 black-color" style={{ display: "block",textAlign:'justify' }}>
    ...
    idleTimeScore: <div>
        <span className="fs-12 fw-700 line-height-18 black-color">Idle Time Score</span>
        <span className="fs-12 fw-400 line-height-18 black-color" style={{ display: "block",textAlign:'justify' }}>
    ...
    timeTrackedScore: <div>
        <span className="fs-12 fw-700 line-height-18 black-color">Time Tracked Score</span>
        <span className="fs-12 fw-400 line-height-18 black-color" style={{ display: "block",textAlign:'justify' }}>
