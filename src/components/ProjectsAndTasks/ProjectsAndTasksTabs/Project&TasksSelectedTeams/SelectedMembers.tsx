    ...
    <div className="wrap-selected-members">
      <div className="selected-members-filter d-flex justify-between">
        ...
        <div className="wrap-member d-flex align-items-center">
          <Input placeholder="Search Task" className="search-member card-bg-color card-bg-3-border-color title-color" />
         {role==="Admin"  && <button
            className="fs-16 fw-500 line-height-24 grey-color d-flex align-items-center justify-between ant-input-affix-wrapper"
            onClick={showModal}
          >
            {" "}
