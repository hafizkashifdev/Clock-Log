    ...
    <div className="wrap-selected-teams">
      <div className="selected-teams-filter d-flex justify-between">
        ...
        <div className="wrap-teams d-flex align-items-center">
          <Input placeholder="Search Task" className="Search-team card-bg-color card-bg-3-border-color title-color" />
          {role =="Admin" && <button
            className="fs-16 fw-500 line-height-24 grey-color d-flex align-items-center justify-between add-team-button ant-input-affix-wrapper"
            onClick={showModal}
          >
            {" "}
