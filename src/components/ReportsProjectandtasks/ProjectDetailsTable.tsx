        ...
        <>
            <div className='projectDetailsHeader'>
                ...
                <div className='search_input'>
                    ...
                    <Input style={{ height: "40px" }} type='text' prefix={<img src={searchIcon} alt="search" />} onChange={(e) => console.log(e.target.value)} className="tasksSearch " placeholder="Search by user" />
                </div>
            </div>
